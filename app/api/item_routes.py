...
@router.get('/list_items', response_model=list[ItemRead], status_code=201)
...
@router.put('/{item_id}', response_model=ItemRead, status_code=200)
...
def delete_item_info_by_id(item_id:int , db: Session = Depends(get_db)):
